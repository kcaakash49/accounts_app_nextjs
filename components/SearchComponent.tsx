...
export default function SearchComponent() {
    ...
    return (
        <div >
            <form onSubmit={handleSubmit} className="relative w-40 sm:w-48 md:w-80">
                ...
                <input
                    ...
                    className="w-full pl-10 pr-4 py-2 text-xs md:text-base rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-white bg-white text-gray-800 placeholder-gray-500"
                />
